...
const Footer: React.FC = () => {
  ...
  return (
    <>
      <footer ref={footerRef} className="text-white pt-24 pb-48 relative z-20" style={{ minHeight: '616px', backgroundColor: '#4f342e' }}>
        ...
        >
          <div className="flex items-center space-x-8 mb-6 md:mb-0">
            {/* Social Icons */}
            <a href="https://www.instagram.com/gourdshadestz?igsh=MTZteGx1OXR5Zno1NQ==" className="text-white/80 hover:text-accent transition-colors">
            ...
            <a href="https://www.facebook.com/gourdshadestz" className="text-white/80 hover:text-accent transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
