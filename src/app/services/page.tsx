            ...
            {[
              {
                step: '01',
                title: 'Consultation',
                description: 'We assess your space and understand your lighting needs.',
              },
              {
                step: '02',
                title: 'Design',
                description: 'Our experts create a customized lighting plan for you.',
              },
              {
                step: '03',
                title: 'Installation',
                description: 'Professional installation by certified electricians.',
              },
              {
                step: '04',
                title: 'Support',
                description: 'Ongoing maintenance and support for your lighting system.',
              },
            ].map((step, index) => (
              <motion.div
                key={step.step}
                ...
                viewport={{ once: true }}
              >
                <div className="text-4xl font-light text-accent mb-4">
                  {step.step}
                </div>
            ...
            {[
              {
                ...
                quote: 'LampCo transformed our hotel lobby with stunning custom chandeliers. The quality and service exceeded all expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Restaurant Owner',
                quote: 'The lighting consultation helped us create the perfect ambiance. Our customers constantly compliment the atmosphere.',
                rating: 5,
              },
              {
                name: 'Emma Davis',
                role: 'Homeowner',
                quote: 'From design to installation, the team was professional and creative. Our home has never looked better.',
                rating: 5,
              },
            ].map((testimonial, index) => (
              <motion.div
                key={testimonial.name}
                className="bg-very-light-gray p-8 rounded-2xl"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                viewport={{ once: true }}
